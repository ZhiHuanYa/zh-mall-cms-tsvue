<template>
  <div class="overview">
    ...
    <zh-card title="技术栈">
      <zh-text-link :text-arrs="technologyStacks" />
      <zh-descriptions
        title="生产环境依赖"
        :column="2"
    ...
    <zh-card title="项目结构">
      <div class="c-left">
        <zh-code language="bash" :code="projectDir"></zh-code>
      </div>
    </zh-card>
    <zh-card title="项目规范">
      <zh-descriptions
...
import ZhDescriptions from '@/base-ui/descriptions'
import ZhTextLink from '@/base-ui/text-link'
import ZhCard from '@/base-ui/card'
import ZhCode from '@/base-ui/code'
